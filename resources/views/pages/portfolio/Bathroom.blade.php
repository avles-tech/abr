@extends('layout.app')
@section('meta')
    <title>ABR Contractors | Portfolio | Bathroom</title>
									...
									<div class="rowcol"> 
										<div class="residential-plumb">
											...
											<div class="col-md-4 col-xs-12 col-sm-6">
												<a class="example-image-link" href="/img/portfolio/Bathroom/Bathroom ({{$x}}).JPG" data-lightbox="example-set" data-title="ABR Construction">
												<div class="service-item">
													<div class="service-thumb">
														<img width="360" src="/img/portfolio/Bathroom/Bathroom ({{$x}}).JPG" alt="Loading">
													</div>
												</div></a>
											</div>
											@endfor
